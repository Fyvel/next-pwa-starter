export default function MetaTags() {
	return (
		<>
			...
			<meta name="keywords" content="WebApp PWA NextJS" />
			...
			<link rel="icon" href="/icons/icon-64X64.png" type="image/png" sizes="64X64" />
			...
			{/* And F*ck you Apple for being such a pain for web crafters... */}
			...
			<link rel="apple-touch-startup-image" href="/assets/apple-splash-2688-1242.jpg" media="(device-width: 414px) and (device-height: 896px) and (-webkit-devicand (orientation: landscape)and (orientation: landscape)" />
